...
| --- | --- | --- |
| **Name**<br /><br /> Nécessaire |**xs:string** |Nom du fichier de ressource. |
| **Taille**<br /><br /> Nécessaire |**xs:long** |Taille du fichier de ressource en octets. |
| **Durée**<br /><br /> Nécessaire |**xs:duration** |Durée de lecture du contenu. Exemple : Duration="PT25M37.757S". |
| **NumberOfStreams**<br /><br /> Nécessaire |**xs:int** |Nombre de flux dans le fichier de ressource. |
| **FormatNames**<br /><br /> Nécessaire |**xs: string** |Noms de format. |
| **FormatVerboseNames**<br /><br /> Nécessaire |**xs: string** |Noms détaillés des formats. |
...
| NOM | type | Description |
| --- | --- | --- |
| **Id**<br /><br /> Nécessaire |**xs:int** |Index de base zéro de cette piste audio ou vidéo.<br /><br /> Il ne s’agit pas nécessairement du trackid tel qu’utilisé dans un fichier MP4. |
| **Codec** |**xs:string** |Chaîne de codec de la piste vidéo. |
| **CodecLongName** |**xs: string** |Nom long du codec de piste audio ou vidéo. |
| **TimeBase**<br /><br /> Nécessaire |**xs:string** |Période. Exemple : TimeBase="1/48000" |
...
| **Canaux**<br /><br /> Nécessaire |**xs:int** |Nombre (0 ou plus) de canaux audio. |
| **SamplingRate**<br /><br /> Nécessaire |**xs:int** |Taux d’échantillonnage audio en échantillons/sec ou Hz. |
...
| NOM | type | Description |
| --- | --- | --- |
| **FourCC**<br /><br /> Nécessaire |**xs:string** |Code FourCC du codec vidéo. |
...
| **Largeur**<br /><br /> Nécessaire |**xs:int** |Largeur vidéo encodée en pixels. |
| **Hauteur**<br /><br /> Nécessaire |**xs:int** |Hauteur vidéo encodée en pixels. |
| **DisplayAspectRatioNumerator**<br /><br /> Nécessaire |**xs: double** |Numérateur des proportions d’affichage vidéo. |
| **DisplayAspectRatioDenominator**<br /><br /> Nécessaire |**xs:double** |Dénominateur des proportions d’affichage vidéo. |
| **DisplayAspectRatioDenominator**<br /><br /> Nécessaire |**xs: double** |Numérateur des proportions d’échantillon vidéo. |
...
| **FrameRate**<br /><br /> Nécessaire |**xs:decimal** |Fréquence d’images vidéo mesurée au format .3f. |
...
| NOM | type | Description |
| --- | --- | --- |
| **key**<br /><br /> Nécessaire |**xs:string** |La clé dans la paire clé/valeur. |
| **value**<br /><br /> Nécessaire |**xs:string** |La valeur dans la paire clé/valeur. |
...
| NOM | type | Description |
| --- | --- | --- |
| **ProgramId**<br /><br /> Nécessaire |**xs:int** |ID de programme |
| **NumberOfPrograms**<br /><br /> Nécessaire |**xs:int** |Nombre de programmes. |
| **PmtPid**<br /><br /> Nécessaire |**xs:int** |Les tables de correspondance de programme (PMT) contiennent des informations sur les programmes.  Pour plus d'informations, consultez [PMt](http://en.wikipedia.org/wiki/MPEG_transport_stream#PMT). |
| **PcrPid**<br /><br /> Nécessaire |**xs: int** |Utilisé par le décodeur. Pour plus d'informations, consultez [PCR](http://en.wikipedia.org/wiki/MPEG_transport_stream#PCR) |
...
| NOM | type | Description |
| --- | --- | --- |
| **Par défaut**<br /><br /> Nécessaire |**xs: int** |Définissez cet attribut sur 1 pour indiquer qu’il s’agit de la présentation par défaut. |
| **Dub**<br /><br /> Nécessaire |**xs:int** |Définissez cet attribut sur 1 pour indiquer qu’il s’agit de la présentation doublée. |
| **Ressource d’origine**<br /><br /> Nécessaire |**xs: int** |Définissez cet attribut sur 1 pour indiquer qu’il s’agit de la présentation d’origine. |
| **Commentaire**<br /><br /> Nécessaire |**xs:int** |Définissez cet attribut sur 1 pour indiquer que cette piste contient des commentaires. |
| **Lyrics**<br /><br /> Nécessaire |**xs:int** |Définissez cet attribut sur 1 pour indiquer que cette piste contient des paroles. |
| **Karaoke**<br /><br /> Nécessaire |**xs:int** |Définissez cet attribut sur 1 pour indiquer qu’il s’agit d’une piste de karaoké (musique de fond, sans voix). |
| **Forced**<br /><br /> Nécessaire |**xs:int** |Définissez cet attribut sur 1 pour indiquer qu’il s’agit la présentation forcée. |
| **HearingImpaired**<br /><br /> Nécessaire |**xs:int** |Définissez cet attribut sur 1 pour indiquer que cette piste est destinée aux personnes malentendantes. |
| **VisualImpaired**<br /><br /> Nécessaire |**xs:int** |Définissez cet attribut sur 1 pour indiquer que cette piste est destinée aux personnes malvoyantes. |
| **CleanEffects**<br /><br /> Nécessaire |**xs: int** |Définissez cet attribut sur 1 pour indiquer que cette piste comporte des effets propres. |
| **AttachedPic**<br /><br /> Nécessaire |**xs: int** |Définissez cet attribut sur 1 pour indiquer que cette piste contient des images. |
