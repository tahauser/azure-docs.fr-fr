...
Pour copier des données de Xero, affectez la valeur **XeroObject** à la propriété de type du jeu de données. Il n’y a aucune autre propriété propre au type dans ce type de jeu de données.
