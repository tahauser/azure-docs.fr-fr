...
> [!IMPORTANT]
> Ce connecteur est actuellement une version bêta. Essayez-le et envoyez-nous vos commentaires. Ne l’utilisez pas dans des environnements de production.
...
Pour copier des données de Shopify, affectez la valeur **ShopifyObject** à la propriété de type du jeu de données. Il n’y a aucune autre propriété propre au type dans ce type de jeu de données.
