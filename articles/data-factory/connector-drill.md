...
Pour copier des données depuis Drill, attribuez la valeur **DrillTable** à la propriété type du jeu de données. Il n’y a aucune autre propriété de type dans cette sorte de jeu de données.
