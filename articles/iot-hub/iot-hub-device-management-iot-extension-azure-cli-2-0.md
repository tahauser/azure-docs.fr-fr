...
## <a name="use-the-iot-extension-for-azure-cli-20-with-direct-methods"></a>Utiliser l’extension IoT pour Azure CLI 2.0 avec les méthodes directes

```bash
az iot hub invoke-device-method --device-id <your device id> --hub-name <your hub name> --method-name <the method name> --method-payload <the method payload>
```

## <a name="use-the-iot-extension-for-azure-cli-20-with-twins-desired-properties"></a>Utiliser l’extension IoT pour Azure CLI 2.0 avec les propriétés souhaitées du jumeau
...
## <a name="use-the-iot-extension-for-azure-cli-20-with-twins-reported-properties"></a>Utiliser l’extension IoT pour Azure CLI 2.0 avec les propriétés rapportées du jumeau
...
## <a name="use-the-iot-extension-for-azure-cli-20-with-twins-tags"></a>Utiliser l’extension IoT pour Azure CLI 2.0 avec les balises du jumeau
...
## <a name="use-the-iot-extension-for-azure-cli-20-with-device-twins-queries"></a>Utiliser l’extension IoT pour Azure CLI 2.0 avec les requêtes de jumeaux d’appareils
