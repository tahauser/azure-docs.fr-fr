...
Cet article vous aide à connecter des réseaux virtuels à l’aide d’une connexion de réseau virtuel à réseau virtuel. Cet article inclut deux ensembles d’étapes distincts. L’un des ensembles est destiné aux [réseaux virtuels qui se trouvent dans le même abonnement](#samesub), et l’autre aux [réseaux virtuels qui se trouvent dans des abonnements différents](#difsub). 
