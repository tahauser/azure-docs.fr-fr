...
| [`az redis create`](/cli/azure/redis?view=azure-cli-latest#az-redis-create) | Crée une nouvelle instance de Cache Redis. |
| [`az redis list-keys`](/cli/azure/redis?view=azure-cli-latest#az-redis-list-keys) | Répertorie les touches d’accès rapide pour l’instance de cache redis. |
