...
1. Cliquez avec le bouton droit sur le projet d'application web et sélectionnez **Convertir > Convertir en projet de service cloud Microsoft Azure**. (Cette commande n'apparaît pas si vous avez déjà un projet de rôle web dans la solution.)
...
- [Migration de base de données SQL Server vers SQL Database dans le cloud](sql-database/sql-database-cloud-migrate.md)
- [Utilisation de NET (C#) avec Visual Studio pour se connecter à une base de données SQL Azure et l’interroger](sql-database/sql-database-connect-query-dotnet-visual-studio.md).
