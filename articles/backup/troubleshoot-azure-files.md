...
description: "Cet article contient des informations de dépannage concernant les problèmes qui se produisent lors de la protection de vos fichiers Azure (partages de fichiers) dans Azure."
services: backup
ms.service: backup
...
| Échec de l’opération de restauration, car le partage de fichiers cible est plein. | Augmentez le quota de taille du partage de fichier cible pour prendre en charge les données de restauration, puis recommencez l’opération. |
