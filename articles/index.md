...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1 class="visually-hidden">Documentation Microsoft Azure</h1>
        <ul class="pivots">
            <li>
...
Terraform </a>
            ...
            <li>
                ...
                <ul id="products">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sauvegarde</h3>
                                                    <p>Protection de vos données avec une sauvegarde dans le cloud en tant que service</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-custom-search"><img src="media/index/API_Bing_Custom_Search.svg" alt="" />Recherche personnalisée Bing</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-entities-search/"><img src="media/index/API_Bing_Entity_Search.svg" alt="" />Recherche d’entité Bing</a>
                                                            </li>
                                                            <li>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="https://labs.cognitive.microsoft.com/en-us/project-gesture"><img src="media/index/labs-hand-gesture.svg" alt="" />Mouvement</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="https://labs.cognitive.microsoft.com/en-us/project-event-tracking"><img src="media/index/labs-event-tracker.svg" alt="" />Suivi des événements</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="https://labs.cognitive.microsoft.com/en-us/project-academic-knowledge"><img src="media/index/API_Know_Academic.svg" alt="" />Connaissances universitaires</a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a class="barLink" href="https://labs.cognitive.microsoft.com/en-us/project-knowledge-exploration"><img src="media/index/API_KnowledgeExploration.svg" alt="" /><span>Service d’exploration des connaissances</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="https://labs.cognitive.microsoft.com/en-us/project-entity-linking"><img src="media/index/API_Entity_LinkingIntelligence.svg" alt="" /><span>Liaison d’entités</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                    ...
                    <li>
                        <a href="#mgmt">Outils de gestion</a>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/python/azure">Obtention de bibliothèques Azure pour Python</a>
                                                </h3>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://docs.microsoft.com/visualstudio/python/python-in-visual-studio">Prise en main de Visual Studio</a>
                                                </p>
                                                <p>
                                                    <a href="https://code.visualstudio.com/docs/languages/python">Prise en main de Visual Studio Code</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Outils et Kit de développement logiciel (SDK) Service Fabric </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started">Téléchargement pour Windows</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-linux">Téléchargement pour Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-mac">Télécharger Mac OS X</a>
                                                </p>
                                                <p>
