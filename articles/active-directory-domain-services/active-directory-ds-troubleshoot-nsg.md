...
> [!NOTE]
> Ce groupe de sécurité réseau par défaut ne bloque pas l’accès au port utilisé pour le protocole LDAP sécurisé. Pour verrouiller l’accès LDAP sécurisé sur Internet, consultez [cet article](active-directory-ds-troubleshoot-ldaps.md).
>
