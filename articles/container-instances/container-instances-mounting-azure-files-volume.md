...
Après le démarrage du conteneur, vous pouvez utiliser l’application web simple déployée via l’image [seanmckenna/aci-hellofiles][aci-hellofiles] pour gérer les fichiers du partage de fichiers Azure sur le chemin de montage que vous avez spécifié. Obtenez l’adresse IP de l’application web avec la commande [az container show][az-container-show] :
