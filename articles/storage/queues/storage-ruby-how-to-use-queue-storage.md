...
Créez une application Ruby. Pour obtenir les instructions, consultez [Créer une application Ruby dans App Service sur Linux](https://docs.microsoft.com/azure/app-service/containers/quickstart-ruby).
