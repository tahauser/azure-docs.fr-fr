...
### <a name="steps"></a>Étapes
  1. Extrayez l’image du conteneur Jenkins de Service Fabric :``docker pull raunakpandya/jenkins:9``
  2. Exécutez l’image de conteneur :``docker run -itd -p 8080:8080 raunakpandya/jenkins:v9``
