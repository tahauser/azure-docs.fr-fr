...
## [Sondes d’équilibreur de charge](load-balancer-custom-probe-overview.md)
## [Ports à haute disponibilité](load-balancer-ha-ports-overview.md)
## [Prise en charge d’IPv6](load-balancer-ipv6-overview.md)
## [Plusieurs serveurs frontaux](load-balancer-multivip-overview.md)
## [Connexions sortantes](load-balancer-outbound-connections.md)
