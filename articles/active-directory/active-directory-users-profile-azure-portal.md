...
3. Sélectionnez **Tous les utilisateurs**.
   ...
   ![Ouverture du groupe Tous les utilisateurs](./media/active-directory-users-profile-azure-portal/create-users-open-users-blade.png)
1. Sélectionnez un utilisateur dans la liste.
2. Pour l’utilisateur sélectionné, sélectionnez **Profil**.
