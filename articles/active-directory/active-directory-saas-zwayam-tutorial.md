...
4. Dans la zone de recherche, tapez **Zwayam**, sélectionnez **Zwayam** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
    ...
    ![Zwayam dans la liste des résultats](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_addfromgallery.png)
...
3. **[Créer un utilisateur de test Zwayam](#create-a-zwayam-test-user)** pour avoir dans Zwayam un équivalent de Britta Simon lié à la représentation Azure AD associée.
...
2. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Boîte de dialogue Authentification unique](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_samlbase.png)

3. Dans la section **Zwayam Domain and URLs** (Domaine et URL Zwayam), procédez comme suit :

    ![Informations d’authentification unique dans Zwayam Domain and URLs (Domaine et URL Zwayam)](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_url.png)
...
4. Dans la section **Certificat de signature SAML**, cliquez sur **Métadonnées XML** puis enregistrez le fichier de métadonnées sur votre ordinateur.
    ...
    ![Lien de téléchargement du certificat](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_certificate.png) 

5. Cliquez sur le bouton **Enregistrer** .

    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/active-directory-saas-zwayam-tutorial/tutorial_general_400.png)

6. Dans la section **Zwayam Configuration** (Configuration de Zwayam), cliquez sur **Configure Zwayam** (Configurer Zwayam) pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’ID d’entité SAML** dans la **section Référence rapide** et collez la valeur **d’ID d’entité SAML** dans la zone de texte **URL de connexion** de la section **Zwayam Domain and URLs** (Domaine et URL Zwayam).

    ![Configuration de Zwayam](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_configure.png) 

7. Pour configurer l’authentification unique côté **Zwayam**, vous devez envoyer le **XML de métadonnées** téléchargé à [l’équipe de support technique Zwayam](mailto:opendoors@zwayam.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le volet gauche du Portail Azure, cliquez sur le bouton **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/active-directory-saas-zwayam-tutorial/create_aaduser_01.png)

2. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.

    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/active-directory-saas-zwayam-tutorial/create_aaduser_02.png)

3. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue **Tous les utilisateurs**.

    ![Bouton Ajouter](./media/active-directory-saas-zwayam-tutorial/create_aaduser_03.png)

4. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :

    ![Boîte de dialogue Utilisateur](./media/active-directory-saas-zwayam-tutorial/create_aaduser_04.png)
...
2. Dans la liste des applications, sélectionnez **Zwayam**.
    ...
    ![Lien Zwayam dans la liste des applications](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_app.png)  
