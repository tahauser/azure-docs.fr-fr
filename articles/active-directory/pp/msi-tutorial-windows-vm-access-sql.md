...
Vous pouvez désormais accorder à votre machine virtuelle l’accès à une base de données sur un serveur Azure SQL.  Pour cette étape, vous pouvez utiliser un serveur SQL existant ou en créer un.  Pour créer un serveur et une base de données à l’aide du portail Azure, procédez de la manière décrite dans cette [procédure de démarrage rapide d’Azure SQL](~/articles/sql-database/sql-database-get-started-portal.md). Des procédures de démarrage rapide utilisant Azure CLI et Azure PowerShell sont également décrites dans la [Documentation Azure SQL Database](~/articles/sql-database/index.yml).
...
- [Authentification universelle avec SQL Database et SQL Data Warehouse (prise en charge de SSMS pour MFA)](~/articles/sql-database/sql-database-ssms-mfa-authentication.md)
- [Configurer et gérer l’authentification Azure Active Directory avec SQL Database ou SQL Data Warehouse](~/articles/sql-database/sql-database-aad-authentication-configure.md)
...
- Apprenez-en davantage sur la [prise en charge d’Azure SQL pour Azure AD Authentication](~/articles/sql-database/sql-database-aad-authentication.md).
- Apprenez-en davantage sur la [configuration de la prise en charge d’Azure SQL pour Azure AD Authentication](~/articles/sql-database/sql-database-aad-authentication-configure.md).
