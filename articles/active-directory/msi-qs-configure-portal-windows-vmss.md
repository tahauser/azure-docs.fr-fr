...
- [Créer un groupe de machines virtuelles identiques dans le portail Azure](../virtual-machine-scale-sets/virtual-machine-scale-sets-create-portal.md)  
...
- À l’aide du portail Azure, accordez à l’identité du service administré d’un groupe de machines virtuelles identiques un [accès à une autre ressource Azure](msi-howto-assign-access-portal.md).
