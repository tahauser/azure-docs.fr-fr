...
Après avoir activé l’identité du service administré sur une ressource Azure, telle qu’une [machine virtuelle Azure](msi-qs-configure-portal-windows-vm.md) ou un [groupe de machines virtuelles identiques Azure](msi-qs-configure-portal-windows-vmss.md) :
...
- Pour activer l’identité du service administré sur une machine virtuelle Azure, consultez [Configurer l’identité du service administré (MSI) d’une machine virtuelle Azure à l’aide du portail Azure](msi-qs-configure-portal-windows-vm.md).
- Pour activer l’identité du service administré sur un groupe de machines virtuelles identiques Azure, consultez [Configurer l’identité du service administré (MSI) d’un groupe de machines virtuelles identiques Azure à l’aide du portail Azure](msi-qs-configure-portal-windows-vmss.md)
