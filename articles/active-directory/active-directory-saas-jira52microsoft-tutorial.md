...
4. Pour générer l’URL des **métadonnées**, effectuez les étapes suivantes :
    ...
    d. Accédez maintenant à la page de propriétés de **Authentification unique Microsoft Azure Active Directory pour JIRA 5.2**, copiez **l’ID d’application** à l’aide du bouton **Copier**, puis collez-le dans le Bloc-notes.
...
11. Effectuez les opérations suivantes dans la page de configuration :
    ...
    > [!NOTE]
    > Pour plus d’informations sur l’installation et de dépannage, consultez le [Guide d’administration du connecteur d’authentification unique MS JIRA](ms-confluence-jira-plugin-adminguide.md) et le [FAQ](ms-confluence-jira-plugin-faq.md).
