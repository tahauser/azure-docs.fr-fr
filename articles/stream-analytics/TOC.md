# [Documentation Stream Analytics](index.md)
...
# Concepts
## Types d’entrée pour un travail
### [Entrée de données diffusées en continu](stream-analytics-define-inputs.md)
### [Entrée de données de référence](stream-analytics-use-reference-data.md)
## [Types de sortie pour un travail](stream-analytics-define-outputs.md)
...
### [Exécuter une instance UDF JavaScript](stream-analytics-javascript-user-defined-functions.md)
...
### [Configurer des alertes](stream-analytics-set-up-alerts.md)

## gérer
### [Mettre à jour un travail](stream-analytics-job-reliability.md)
### [Mettre à jour les informations d’identification](stream-analytics-login-credentials-inputs-outputs.md)

## Créer des solutions
### [Analyse d’opinions Twitter](stream-analytics-twitter-sentiment-analysis-trends.md)
### [Détection des fraudes en temps réel](stream-analytics-real-time-fraud-detection.md)
### [Exécuter des travaux sur IoT Edge](stream-analytics-edge.md) 
### [Analyse des données de capteur de poste de péage](stream-analytics-build-an-iot-solution-using-stream-analytics.md)
...
### [Surveiller les travaux - Portail](stream-analytics-monitoring.md)
### [Surveiller les travaux - PowerShell](stream-analytics-monitor-and-manage-jobs-use-powershell.md)
### [Surveiller les travaux - SDK Azure .Net](stream-analytics-monitor-jobs.md)

## Scale
### [Mettre à l’échelle avec unités de streaming](stream-analytics-streaming-unit-consumption.md)
### [Mettre à l’échelle avec la parallélisation de requêtes](stream-analytics-parallelization.md)
#### [Augmenter le débit](stream-analytics-scale-jobs.md)
### [Mettre à l’échelle avec des fonctions ML](stream-analytics-scale-with-machine-learning-functions.md)

## Automatisation
### [Utilisation du kit de développement logiciel (SDK) .NET](stream-analytics-dotnet-management-sdk.md)
### [Utilisation de Microsoft Azure PowerShell](https://github.com/Azure/azure-stream-analytics/tree/master/Samples/ASAOneClick)
...
### [Procédure de résolution](stream-analytics-troubleshooting-guide.md)
### [Problèmes courants](stream-analytics-common-troubleshooting-issues.md)
### [Diagramme de travail](stream-analytics-job-diagram-with-metrics.md)
### [Journaux de diagnostic](stream-analytics-job-diagnostic-logs.md)
### [Vérifier l’intégrité des ressources](stream-analytics-resource-health.md)
### [Instruction SELECT INTO](stream-analytics-select-into.md)
### [Récepteurs Event Hub](stream-analytics-event-hub-consumer-groups.md)
...
## [Vidéos](https://azure.microsoft.com/resources/videos/index/?services=stream-analytics&sort=newest)
