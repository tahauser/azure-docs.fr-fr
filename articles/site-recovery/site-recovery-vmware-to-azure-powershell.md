---
title: "Répliquer et basculer des machines virtuelles VMware vers Azure à l’aide d’Azure Site Recovery PowerShell | Microsoft Docs"
description: "Répliquer et basculer des machines virtuelles VMware vers Azure à l’aide d’Azure Site Recovery PowerShell"
...
---
# <a name="replicate-and-failover-vmware-virtual-machines-to-azure-using-azure-site-recovery-powershell"></a>Répliquer et basculer des machines virtuelles VMware vers Azure à l’aide d’Azure Site Recovery PowerShell
...
Avant de commencer :
- Assurez-vous que vous comprenez [l’architecture et les composants du scénario](concepts-vmware-to-azure-architecture.md).
...
* [Sélectionner vos objectifs en matière de protection](site-recovery-set-up-vmware-to-azure.md#choose-your-protection-goals)
* [Configurer l’environnement source](site-recovery-set-up-vmware-to-azure.md#set-up-the-source-environment) 
...
## <a name="add-a-vcenter-server-and-discover-vmware-virtual-machines"></a>Ajouter un serveur vCenter et découvrir des machines virtuelles VMware
...
|CentOSVM1       |ConfigurationServer   |replicationstdstorageaccount1| Non applicable                 |ReplicationPolicy|LinuxAccount                             |VMwareDRToAzurePs      |ASR-vnet                 |Subnet-1       |   
|CentOSVM2       |ConfigurationServer   |replicationstdstorageaccount1| Non applicable                 |ReplicationPolicy|LinuxAccount                             |VMwareDRToAzurePs      |ASR-vnet                 |Subnet-1       |   
