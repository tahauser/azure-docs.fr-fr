...
Vérifiez les propriétés du serveur et que le serveur est conforme aux [conditions requises Azure](site-recovery-support-matrix-to-azure.md#failed-over-azure-vm-requirements) pour les machines virtuelles.
