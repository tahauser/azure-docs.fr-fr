...
## <a name="next-steps"></a>étapes suivantes
  [Découvrez-en plus](site-recovery-role-based-linked-access-control.md) sur le contrôle d’accès en fonction du rôle pour gérer les déploiements Azure Site Recovery.
