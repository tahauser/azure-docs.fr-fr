...
![Résumé local](media/site-recovery-hyper-v-deployment-planner-analyze-report/on-premises-summary-h2a.png)
...
![Comptes de stockage Azure requis](media/site-recovery-hyper-v-deployment-planner-analyze-report/required-storage-accounts-h2a.png)
...
![Résumé de l’estimation des coûts](media/site-recovery-hyper-v-deployment-planner-analyze-report/cost-estimation-summary-h2a.png)
...
![Détails du traitement par lot de la réplication initiale](media/site-recovery-hyper-v-deployment-planner-analyze-report/ir-batching-for-rpo-h2a.png)

![Détails complémentaires du traitement par lot de la réplication initiale](media/site-recovery-hyper-v-deployment-planner-analyze-report/ir-batching-for-rpo2-h2a.png)
