...
Pour tester le client Microsoft Genomics, téléchargez le fichier de configuration à partir du compte Genomics. Pour accéder à votre compte Genomics, cliquez sur **Plus de services** dans la zone inférieure gauche, activez le filtrage, puis sélectionnez les comptes Genomics.
