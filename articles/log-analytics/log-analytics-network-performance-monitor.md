...
La zone **Principaux liens réseau défectueux** affiche la liste des liens réseau non intègres. Il s’agit des liaisons réseau actuellement confrontées à un ou plusieurs événements d’intégrité indésirables.
