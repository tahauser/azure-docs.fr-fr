---
title: API Table Azure Cosmos DB pour Java | Microsoft Docs
...
|   |   |
|---|---|
|**Téléchargement du Kit de développement logiciel (SDK)**|[Options de téléchargement](https://github.com/azure/azure-storage-java#download)|
