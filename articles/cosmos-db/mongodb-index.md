---
title: "Azure Cosmos DB : Articles se rapportant à l’API MongoDB | Microsoft Docs"
description: "Liste de tous les articles ayant trait à la création de bases de données de documents avec l’API MongoDB dans Azure Cosmos DB."
services: cosmos-db
author: mimig1
manager: jhubbard
documentationcenter: 
...
À votre disposition ici, des rubriques et des ressources dont la lecture se révèle indispensable pour développer votre connaissance de l’API MongoDB pour Azure Cosmos DB.
...
- Vidéo : [Node.js + Angular](tutorial-develop-mongodb-nodejs.md)
- Vidéo : [Node.js + React](tutorial-develop-mongodb-react.md)

### <a name="migrate-mongodb-data"></a>Migrer des données MongoDB

- [Importer des données MongoDB](mongodb-migrate.md)

### <a name="work-with-data"></a>Utilisation des données

- [Requêtes shell MongoDB](tutorial-query-mongodb.md)
- [Distribuer des données dans le monde](tutorial-global-distribution-mongodb.md)

## <a name="developers-guide"></a>Guide du développeur

- [Utilisation de Studio 3T (MongoChef)](mongodb-mongochef.md)
- [Utilisation de Robomongo](mongodb-robomongo.md)
