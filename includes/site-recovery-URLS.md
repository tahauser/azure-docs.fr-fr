``*.accesscontrol.windows.net``. Élément utilisé pour la gestion des identités et le contrôle d’accès. (L’authentification ACS sera dépréciée d’ici le mois de décembre 2017.) <br/><br/>
