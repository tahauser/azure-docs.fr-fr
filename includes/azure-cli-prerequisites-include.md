...
Pour exécuter la procédure indiquée dans cet article, vous devez [installer l’interface de ligne de commande Azure pour Mac, Linux et Windows (Azure CLI)](../articles/cli-install-nodejs.md) et [ouvrir une session sur Azure](/cli/azure/authenticate-azure-cli). 
